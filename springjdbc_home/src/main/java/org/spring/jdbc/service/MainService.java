...
public class MainService {
    ...
    public void initDB() {
        ...
        jdbcTemplate.execute("CREATE TABLE Comment(id INT PRIMARY KEY, dateAdded DATE, text VARCHAR(255))");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Comment_project");
        jdbcTemplate.execute("CREATE TABLE Comment_project(commentId INT, projectId INT, PRIMARY KEY(commentId, projectId))");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Community");
        jdbcTemplate.execute("CREATE TABLE Community(id INT PRIMARY KEY, name VARCHAR(255))");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Donation");
        jdbcTemplate.execute("CREATE TABLE Donation(id INT PRIMARY KEY, amount BIGINT(64), dateAdded DATE )");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Project");
        jdbcTemplate.execute("CREATE TABLE Project(id INT PRIMARY KEY,  address1 VARCHAR(255), address2 VARCHAR(255),city VARCHAR(255), dateAdded VARCHAR(255), description VARCHAR(255), email VARCHAR(255),firstname  VARCHAR(255), lastname VARCHAR(255), phone VARCHAR(255), state VARCHAR(255), zip VARCHAR(255),title VARCHAR(255))");
        ...
        jdbcTemplate.execute("CREATE TABLE Service_EO(id INT PRIMARY KEY, name VARCHAR(255),description VARCHAR(255), date DATE )");
        ...
        jdbcTemplate.execute("CREATE TABLE Skills(id INT PRIMARY KEY, name VARCHAR(255))");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Tools");
        jdbcTemplate.execute("CREATE TABLE Tools(id INT PRIMARY KEY, name VARCHAR(255))");
        jdbcTemplate.execute("DROP TABLE IF EXISTS Users");
        jdbcTemplate.execute("CREATE TABLE Users(id INT PRIMARY KEY, name VARCHAR(255), email VARCHAR(255), phone VARCHAR(255))");
